<nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#2e4057">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="form-inline my-2 my-lg-0">
                    <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" style="position:relative;right:5%;height:1%">
                    <a type="button" class="btn btn-outline-light" style="position:relative;right:5%;">
                ...
                <a type="button" class="btn btn-outline-light" href="http://homestead.test/projeto/customer/account/login.php">
